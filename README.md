...
<p align="center"><img src="assets/project-config-flow.gif" alt="GitHub Integration Setup"><br><sub>Interactive setup for PR workflows, GitHub tracking, issue creation, and CI scaffolding</sub></p>
