...
This workflow is executed by a verification subagent spawned from phase-execute.md.
</purpose>
...
<!-- Goal-backward derivation expertise is baked into the kata-verifier agent -->
</step>
...
**Return results to phase-execute orchestrator.**
