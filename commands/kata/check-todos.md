...
1. Continue with current phase (/kata:progress)
...
- `/kata:check-todos` → show all
- `/kata:check-todos api` → filter to area:api only
</step>
...
- `/kata:check-todos [area]` to filter by area
- `q` to exit
```
