...
files_modified:
  ...
  - tests/skills/kata-starting-new-projects.test.js
...
must_haves:
  truths:
    ...
    - "kata-starting-new-projects triggers on 'new project' prompt"
...
<objective>
Create test files for the third batch of 3 skills: kata-researching-phases, kata-starting-new-projects, and kata-verifying-work-outcomes-and-user-acceptance-testing.
...
<task type="auto">
  <name>Task 2: Create kata-starting-new-projects.test.js</name>
  <files>tests/skills/kata-starting-new-projects.test.js</files>
  <action>
Create test file following the exact pattern:
- Same imports, setup, and cleanup
- Install skill from skills/kata-starting-new-projects
...
Each test uses same pattern: invokeClaude, assertNoError, assertSkillInvoked
  ...
  <verify>node --check tests/skills/kata-starting-new-projects.test.js</verify>
  <done>Test file exists at tests/skills/kata-starting-new-projects.test.js with at least 2 trigger tests</done>
</task>
...
ls -la tests/skills/kata-starting-new-projects.test.js
...
node --check tests/skills/kata-starting-new-projects.test.js
...
- [ ] kata-starting-new-projects.test.js exists with 2+ trigger tests
