...
<task type="auto">
  ...
  <files>commands/kata/work-pause.md, commands/kata/work-resume.md, commands/kata/codebase-map.md, commands/kata/todos-add.md, commands/kata/todo-check.md</files>
  <action>
**commands/kata/work-pause.md:**
...
- argument-hint: "" (no args)
- Body: Delegate to kata-providing-progress-and-status-updates skill with operation="project-analyze"
...
grep "disable-model-invocation: true" commands/kata/work-pause.md commands/kata/todos-add.md
```
  </verify>
...
<success_criteria>
- [ ] 8 command files exist (phase-plan, phase-execute, work-verify, work-pause, work-resume, codebase-map, todos-add, todo-check)
