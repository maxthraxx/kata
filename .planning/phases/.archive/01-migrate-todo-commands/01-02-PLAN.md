...
1. **Overview:**
   - Purpose: Detailed workflows for each todos-lists action
...
4. **Action 3: Create New Phase**
   **Behavior:** Route to kata-managing-project-roadmap phase-add operation
   **Steps:**
   ...
   3. Display:
      ...
      ```
   4. Invoke: `/kata-managing-project-roadmap phase-add`
