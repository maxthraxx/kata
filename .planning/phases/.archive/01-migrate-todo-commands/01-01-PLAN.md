...
Purpose: Migrate todos-add command functionality to skill-based invocation with natural language triggers and improved UX (area/type inference, duplicate detection).
