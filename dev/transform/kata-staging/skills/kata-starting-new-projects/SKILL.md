...
description: Use this skill when starting new projects, initializing Kata, or setting up project structure. Triggers include "new project", "start project", and "initialize project".
---
