---
name: kata-showing-progress
description: Use this skill when checking progress, reviewing status, or seeing what's done. Triggers include "show progress", "check status", and "where are we".
---
