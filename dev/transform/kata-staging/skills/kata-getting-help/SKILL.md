---
name: kata-getting-help
description: Use this skill when requesting help, learning about Kata commands, or getting started. Triggers include "help", "how do I", and "what commands".
---
...
Requires `/kata:analyze-codebase` to build the graph first.

Usage: `/kata:query-intel dependents src/lib/db.ts`
Usage: `/kata:query-intel hotspots`
