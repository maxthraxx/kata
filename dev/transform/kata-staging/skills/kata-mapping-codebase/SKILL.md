---
name: kata-mapping-codebase
description: Use this skill when mapping codebase structure, documenting architecture, or creating codebase overviews. Triggers include "map codebase", "document structure", and "create map".
---
