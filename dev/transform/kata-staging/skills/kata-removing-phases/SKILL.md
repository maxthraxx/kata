...
description: Use this skill when removing phases, deleting planned work, or cleaning up roadmap. Triggers include "remove phase", "delete phase", and "cancel phase".
---
