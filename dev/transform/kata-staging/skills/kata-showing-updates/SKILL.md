---
name: kata-showing-updates
description: Use this skill when checking what's new, viewing recent changes, or seeing latest features. Triggers include "what's new", "show changes", and "recent updates".
---
