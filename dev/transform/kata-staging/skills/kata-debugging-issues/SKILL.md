---
name: kata-debugging-issues
description: Use this skill when diagnosing bugs, investigating issues, or troubleshooting problems. Triggers include "debug", "investigate bug", and "diagnose issue".
---
