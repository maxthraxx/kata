...
description: Use this skill when setting model profiles, configuring AI behavior, or adjusting generation settings. Triggers include "set profile", "change model", and "configure profile".
---
