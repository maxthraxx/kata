...
description: Use this skill to plan detailed phases as part of the roadmap. Triggers include "plan phase", "create phase plan", "create a plan" "roadmap planning", and "roadmap phase creation".
metadata:
  version: "0.1.0"
